            ...
            <div class="list-body" v-for="(vo,key) in list" :key="key">
                ...
                <div class="head-body">
                    ...
                    <div class="head-right">
                        <div class="jc-btn" @click="onRelieve(vo.user_id)">解除Link</div>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onRelieve(id){
                let _this=this;
                this.$confirm('是否解除与该用户的linker关系?', '确认', {
                    confirmButtonText: '确认',
                    cancelButtonText: '取消',
                    type: 'warning'
                }).then(() => {
                    _this.common.request('api/userLinker/handel',{id:id},function (res) {
                        if(res.status == 200){
                            _this.$message({
                                message: res.message,
                                type: 'success',
            ...
            getList(){
                ...
                _this.common.request('api/userLinker/myLinkerList',data,function (res) {
                    if(res.status == 200){
